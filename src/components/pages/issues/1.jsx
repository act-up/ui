    ...
    render() {
        ...
        return(
            <Container text>
                ...
                <Grid>
                    <Grid.Row centered>
                        <Button color='blue' variant='primary'><a class='whitelink' href={mailto_link} target='_blank' rel='noopener noreferrer'>Go to Contact Page</a></Button>
                    </Grid.Row>
